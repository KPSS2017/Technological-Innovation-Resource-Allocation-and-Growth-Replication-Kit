* Firm Profits and innovation using both our measure and citation-weighted patents (Panel a of Table 6 in the paper) 
...
eststo prod_C0: qui xi: cluster2  F0logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f Lvol_iret  LlogP ,  fcluster(permno) tcluster(year)
qui xi: reg  F0logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f Lvol_iret  L.logP  
...
predict F0logPp, xb
gen F0logPnC=F0logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)

eststo prod_C1: qui xi: cluster2  F1logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  LlogP ,  fcluster(permno) tcluster(year)
qui xi: reg  F1logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  L.logP 
...
predict F1logPp, xb
gen F1logPnC=F1logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)

eststo prod_C2: qui xi: cluster2  F2logP    LlogK  LlogH    i.year i.indcd LSA2i   LSA2f   LSA1i LSA1f Lvol_iret  LlogP ,  fcluster(permno) tcluster(year)
qui xi: reg  F2logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  L.logP 
...
predict F2logPp, xb
gen F2logPnC=F2logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)

eststo prod_C3: qui xi: cluster2 F3logP    LlogK LlogH     i.year i.indcd LSA2i   LSA2f   LSA1i LSA1f Lvol_iret  LlogP ,  fcluster(permno) tcluster(year)
qui xi: reg  F3logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  L.logP 
...
predict F3logPp, xb
gen F3logPnC=F3logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)

eststo prod_C4: qui xi: cluster2  F4logP   LlogK  LlogH     i.year i.indcd LSA2i   LSA2f   LSA1i LSA1f Lvol_iret   LlogP ,  fcluster(permno) tcluster(year)
qui xi: reg  F4logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  L.logP 
...
predict F4logPp, xb
gen F4logPnC=F4logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)


eststo prod_C5: qui xi: cluster2 F5logP    LlogK   LlogH   i.year i.indcd LSA2i   LSA2f   LSA1i LSA1f Lvol_iret  LlogP , fcluster(permno) tcluster(year)
qui xi: reg  F5logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  L.logP 
...
predict F5logPp, xb
gen F5logPnC=F5logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)

eststo prod_C6: qui xi: cluster2  F6logP    LlogK  LlogH    i.year i.indcd LSA2i   LSA2f   LSA1i LSA1f Lvol_iret  LlogP ,  fcluster(permno) tcluster(year)
qui xi: reg  F6logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  L.logP 
...
predict F6logPp, xb
gen F6logPnC=F6logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)

eststo prod_C7: qui xi: cluster2 F7logP    LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  Lvol_iret   LSA1i LSA1f LlogP ,  fcluster(permno) tcluster(year)
qui xi: reg  F7logP     LlogK  LlogH    i.year i.indcd LSA2i   LSA2f  LSA1i LSA1f  Lvol_iret  L.logP 
...
predict F7logPp, xb
gen F7logPnC=F7logPp-(_b[LSA2i]*LSA2i + _b[LSA2f]*LSA2f+_b[LSA1i]*LSA1i + _b[LSA1f]*LSA1f)
