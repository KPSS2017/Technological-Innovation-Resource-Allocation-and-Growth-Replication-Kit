* Firm TFP and innovation using citation-weighted patents (Panel e of Table 5 in the paper) 
...
matrix sto12[1,1]=r(sd) * _b[LSA2f]
qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,1]=r(sd) * _b[LSA2i]
...
qui sum    LSA2f if e(sample)==1,d
matrix sto12[1,2]=r(sd) * _b[LSA2f]
qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,2]=r(sd) * _b[LSA2i]
...
qui sum    LSA2f if e(sample)==1,d
matrix sto12[1,3]=r(sd) * _b[LSA2f]

qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,3]=r(sd) * _b[LSA2i]
...
qui sum    LSA2f if e(sample)==1,d
matrix sto12[1,4]=r(sd) * _b[LSA2f]

qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,4]=r(sd) * _b[LSA2i]
...
qui sum    LSA2f if e(sample)==1,d
matrix sto12[1,5]=r(sd) * _b[LSA2f]

qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,5]=r(sd) * _b[LSA2i]
...
qui sum    LSA2f if e(sample)==1,d
matrix sto12[1,6]=r(sd) * _b[LSA2f]

qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,6]=r(sd) * _b[LSA2i]
...
qui sum    LSA2f if e(sample)==1,d
matrix sto12[1,7]=r(sd) * _b[LSA2f]

qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,7]=r(sd) * _b[LSA2i]
...
qui sum    LSA2f if e(sample)==1,d
matrix sto12[1,8]=r(sd) * _b[LSA2f]

qui sum    LSA2i if e(sample)==1,d
matrix sto12[2,8]=r(sd) * _b[LSA2i]
...
* The standardized coefficients of Panel e of Table 5
mat list sto12
